  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Cricket Scoring App, where cricket scoring becomes the simplest task. Dive in to experience the ultimate ease in scoring your favorite game."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1593341646782-e0b495cff86d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcmlja2V0fGVufDB8fHx8MTY5ODA2OTA1OXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@yogendras31?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Yogendra Singh`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Cricket Scoring App, where cricket scoring becomes the simplest task. Dive in to experience the ultimate ease in scoring your favorite game.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Team Owner" type="team-owner" abilities={appConfig.ownerAbilities} />
